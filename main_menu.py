...
""")
    ...
    print("You can choose from 3 difficulties:")
    rprint("[#00C8FF] - 1. Easy (Only Countries) [/#00C8FF]")
    rprint("[#00FF51] - 2. Hard (Countries and capitals; >10 characters) [/#00FF51]")
    rprint("[#E30E0E] - 3. Hardcore (Countries and capitals; 10+ characters) [/#E30E0E]")

    print("-----------------------------------")
    try:
        jatekmod = int(input("Which one do you want to try? (1, 2, 3) "))
        if jatekmod == 1:
            gamemode_easy()
        elif jatekmod == 2:
            gamemode_hard()
        ...
        print("Please enter a correct number! (1-3)")
